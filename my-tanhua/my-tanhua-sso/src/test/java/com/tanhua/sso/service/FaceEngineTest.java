...
public class FaceEngineTest {
    ...
    public static void main(String[] args) {
        ...
        //从官网获取
        String appId = "BnPYd44ieNjMikDpAsxpkZhomvW23ZmZ98SXNnRLVBZG";
        String sdkKey = "9DCg2D8jZmN3MAjK62VyYXdrhBisRm4kfiw9YEv28r1j";


        FaceEngine faceEngine = new FaceEngine("E:\\code\\WIN64");
        //激活引擎
        ...
        //人脸检测2
        ImageInfo imageInfo2 = getRGBData(new File("E:\\111\\t.jpg"));
        List<FaceInfo> faceInfoList2 = new ArrayList<FaceInfo>();
        errorCode = faceEngine.detectFaces(imageInfo2.getImageData(), imageInfo2.getWidth(), imageInfo2.getHeight(),imageInfo.getImageFormat(), faceInfoList2);
        System.out.println("人脸检测2----");
        ...
        //IR属性处理
        ImageInfo imageInfoGray = getGrayData(new File("E:\\111\\t.jpg"));
